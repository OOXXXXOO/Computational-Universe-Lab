...
def _schema_self_hash(
    ...
    _declared_fields=(
        ...
        ("attestation_schema_version", ("attestation_sha",)),
        ("attempt_schema_version", ("attempt_sha",)),
        ("audit_schema_version", ("audit_sha",)),
        ("authority_schema_version", ("authority_sha",)),
        ...
        ("bridge_spec_schema_version", ("bridge_spec_sha",)),
        ...
        ("certificate_schema_version", ("certificate_sha",)),
        ("component_body_schema_version", ("component_sha",)),
        ("construction_schema_version", ("construction_sha",)),
        ("coverage_schema_version", ("coverage_sha",)),
        ...
        ("graph_manifest_schema_version", ("graph_sha",)),
        ...
        ("origin_schema_version", ("origin_sha",)),
        ("parent_freeze_schema_version", ("parent_freeze_v3_sha",)),
        ("permit_schema_version", ("permit_sha",)),
        ("prestructure_schema_version", ("prestructure_authority_sha",)),
        ...
        ("residual_schema_version", ("residual_sha",)),
        ("run_spec_schema_version", ("run_spec_sha",)),
        ("runtime_schema_version", ("runtime_manifest_sha",)),
